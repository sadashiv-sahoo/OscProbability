/**
 *
 *  @file OscGetLIVFunctions.cxx
 *
 *  @brief It deals with Physics associated with LIV related Functions.
 *
 *  @author
 *
 *  SADASHIV SAHOO <br>
 ...
 **/
    ...
    //* Get the Oscillation Parameters (LIV) *//
      double** OscProbabilityLIV ::
      GetVacLIVOscParms(int type, double Erg, const char *wh)
    {
      ...
      double** OscProbabilityLIV ::
      GetConstMatLIVOscParms(int type, double dens, double Erg, const char *wh)
    {
        OscProbabilitySTD :: Shall_I_Proceed_For_Modified_Calc();
        if (type != 0 && dens >= 0.0)
      {
